...
class bpxl_social_widget extends WP_Widget {
	...
	function bpxl_social_widget() {
		...
		$this->WP_Widget( 'social_widget', __('(UBlog) Social Widget', 'bloompixel'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		<div class="social-widget">
			...
			<ul>
				...
				<?php } ?>
				<?php if ( $flickr ) { ?>
					<li class="flickr uppercase"><a href="<?php echo $flickr; ?>" <?php if ( $social_target == 1 ) { echo 'target="_blank"'; } ?>><span class="fa fa-flickr"></span></a></li>
				<?php } ?>
				<?php if ( $instagram ) { ?>
				...
				<?php } ?>
				<?php if ( $youtube ) { ?>
					<li class="youtube uppercase"><a href="<?php echo $youtube; ?>" <?php if ( $social_target == 1 ) { echo 'target="_blank"'; } ?>><span class="fa fa-youtube-play"></span></a></li>
				<?php } ?>
				<?php if ( $tumblr ) { ?>
				...
				<?php } ?>
				<?php if ( $xing ) { ?>
					<li class="xing uppercase"><a href="<?php echo $xing; ?>"><span class="fa fa-xing-square"></span></a></li>
				<?php } ?>
			</ul>
		</div>
		<!-- END WIDGET -->
