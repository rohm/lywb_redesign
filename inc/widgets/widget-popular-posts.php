...
class bpxl_popular_widget extends WP_Widget {
	...
	// Widget Setup 
	function bpxl_popular_widget() {
		$widget_ops = array( 'classname' => 'popular_posts', 'description' => __('A widget that displays the popular posts of your blog', 'bloompixel') );
		$control_ops = array( 'id_base' => 'popular_widget' );
		$this->WP_Widget( 'popular_widget', __('(UBlog) Popular Posts', 'bloompixel'), $widget_ops, $control_ops );
	}
							...
							<div class="thumbnail-big thumbnail">
								<a class="widgetthumb" href='<?php the_permalink(); ?>'>
									<?php if(has_post_thumbnail()):
										...
										<img src="<?php echo get_template_directory_uri(); ?>/images/395x175.png" width='395' height='175' alt="<?php the_title(); ?>" class="wp-post-image" />
									<?php endif; ?>
								</a>
							</div>
					<?php }
