...
class bp_160_widget extends WP_Widget {
	...
	// Widget Setup 
	function bp_160_widget() {
		$widget_ops = array( 'classname' => 'bp_160_widget', 'description' => __('A widget that displays 160x600 ad', 'bloompixel') );
		$control_ops = array( 'width' => '160', 'height' => '600', 'id_base' => 'bp_160_widget' );
		$this->WP_Widget( 'bp_160_widget', __('(UBlog) 160x600 Ad Widget', 'bloompixel'), $widget_ops, $control_ops );
	}
	...
	function widget( $args, $instance ) {
		...
		<div class="ad-widget-160">
			<?php
				...
				elseif ( $link )
					echo '<a href="' . $link . '"><img src="' . $banner . '" width="160" height="600" alt="" /></a>';
					
				elseif ( $banner )
					echo '<img src="' . $banner . '" width="160" height="600" alt="" />';
			?>
		</div>
		<!-- END WIDGET -->
		<?php
